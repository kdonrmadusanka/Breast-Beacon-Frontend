...
import Particles from "react-tsparticles"; // Using react-tsparticles
    ...
    () => ({
      ...
      particles: {
        ...
        move: {
          ...
          enable: true,
          outModes: { default: "out" as const }, // Fixed: Assert default as literal
          random: true,
        ...
        number: {
          density: {
            enable: true,
            value_area: 800, // Use value_area for react-tsparticles
          },
          value: 80,
        },
        opacity: {
          value: { min: 0.1, max: 0.3 },
          anim: { enable: true, speed: 1, sync: false }, // Use anim for react-tsparticles
        },
        shape: { type: "circle" },
        size: {
          value: { min: 1, max: 3 },
